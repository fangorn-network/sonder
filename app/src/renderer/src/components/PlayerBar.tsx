    ...
    <div className="player-bar" style={hidden ? { display: 'none' } : undefined}>
      ...
      <div className="player-center">
        <div className="player-controls">
          <button className="player-btn player-btn--skip" disabled style={{ opacity: 0.2 }} title="Previous">
          ...
          <button className="player-btn player-btn--skip" onClick={onPlayNext} title="Next">
            <svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor">
